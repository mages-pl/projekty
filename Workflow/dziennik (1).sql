...
--
-- Host: localhost
-- Czas generowania: 04 Lis 2018, 09:17
...
INSERT INTO `listanauczycieli` (`idlistaNauczycieli`, `imie`, `nazwisko`, `email`, `haslo`) VALUES
...
--
ALTER TABLE `listanauczycieli`
  MODIFY `idlistaNauczycieli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
